          ...
          <div className="MaterialForm">
            ...
            <div>
              {isLoading ? (
                ...
                <>
                  <button
                    type="button"
                    className="chooseFileButton btn btn--m"
            ...
            <Formik
              ...
              validationSchema={object({
                name: string()
                  .required("Missing film name")
                  .min(2, "Please enter valid name"),
                year: string()
                  .required("Missing film issue year")
                  .min(2, "Please enter correct year"),
                // club: string().required("Select your club"),
                clip: string().required("Missing film link"),
                info: string().required("Missing film detail"),
                nation: string().required("Missing film nation"),
                famous: bool().oneOf([true], "Check film detail agian"),
                status: string(),
              })}
              ...
              {({ errors, isValid, touched, dirty }) => (
                <Form>
                  ...
                  <div className={styles.recap}>
                    ...
                    />
                    <span>Confirm film details</span>
                  </div>
